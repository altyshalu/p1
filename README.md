...
uv run python scripts/real-p1-proof-pack.py   --base-url http://127.0.0.1:8000   --env-file .env   --mode full_pipeline   --approve   --verify-sheet   --verify-outreach-master   --verify-data-lake   --verify-quality
