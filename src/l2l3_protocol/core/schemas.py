...
class ArtifactType(StrEnum):
    ...
    P2_RAW_STARTUP_ROWS = "p2_raw_startup_rows"
    P2_NORMALIZED_STARTUPS = "p2_normalized_startups"
    P2_FOUNDER_LINKS_RESOLVED = "p2_founder_links_resolved"
    P2_WEBSITE_VERIFICATION = "p2_website_verification"
    P2_SECTOR_CLASSIFICATION = "p2_sector_classification"
    P2_ICP_SCORES = "p2_icp_scores"
    P2_SYNTHETIC_BENCHMARKS = "p2_synthetic_benchmarks"
    P2_JUDGE_RESULTS = "p2_judge_results"
    P2_SUITABLE_STARTUPS = "p2_suitable_startups"
    P2_APPROVAL_PACKAGE = "p2_approval_package"
    P2_EXTERNAL_ACTION_PREVIEW = "p2_external_action_preview"
    P2_GOOGLE_SHEETS_SYNC_RESULT = "p2_google_sheets_sync_result"
    P2_METRICS_REPORT = "p2_metrics_report"
    GENERIC = "generic"
